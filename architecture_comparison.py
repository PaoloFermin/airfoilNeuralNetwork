...
def create_model():
	...
	model = Sequential()
	model.add(Dense(32, kernel_initializer='normal', activation='relu', input_shape=(n_cols,))) 
...
def train_model():
	...
	#train model
	fit = model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=15000, callbacks=[tb, early_stopping_monitor], verbose=False)
